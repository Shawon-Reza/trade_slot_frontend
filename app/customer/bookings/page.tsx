  ...
  return (
    ...
    >
      <div className="space-y-8 max-w-5xl">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">My Bookings</h1>
          <p className="text-zinc-600 dark:text-zinc-400 mt-1">View and manage your bookings.</p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 text-center">
          <p className="text-zinc-500 dark:text-zinc-400">Bookings management will be available soon.</p>
        </div>
      </div>
    </DashboardLayout>
  );
